...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3403',
            //extent: [-329009.650585, 5425574.183824, 1429078.906990, 6659287.192815],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-1974432.373566, 5225241.827201, 2564074.122445, 7011914.018509], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_FishStockingPoints_2,
    colName: 'WATERBODY',
    zoom: 10,
    collapsed: true,
    map: map
